...
import com.makyg.ge.Model.Comment
...
class CommentAdapter(private val mContext: Context, private var mComment: MutableList<Comment>?) : RecyclerView.Adapter<CommentAdapter.ViewHolder>() {
